...
const PageOne: React.FC<PageProps> = ({
  ...
  const [imageList, setImageList] = useState<string[]>(formData.images);
  ...
  const electricIncluded = formData.electricIncluded;
  const waterIncluded = formData.waterIncluded;
  const internetIncluded = formData.internetIncluded;
